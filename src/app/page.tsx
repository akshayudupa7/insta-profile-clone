...
export default function page() {
  return (
    <div className="grid grid-cols-12">
      ...
      <div className="md:hidden col-span-4 col-span-2  gap-1  mb-1 border-2 border-t-2 border-gray-200 gap-8 mt-8 my-12 h-[100%] w-[100%] rounded-full overflow-hidden h-[80px] w-[80px] mx-auto rounded-[300px] rounded-[300px] bg-gray-100  mt-4 my-4 font-bold   bg-[#0099e6]  text-[#fff] px-[18px] py-[8px] rounded-[12px]  justify-center pt-8 w-[50%] w-[90%]rounded-[100px] justify-between col-span-3 grid grid-cols-12 flex gap-8 grid grid-cols-3 grid grid-cols-12 gap-4 col-span-4"></div>
      <div className="flex mt-2 justify-center">
        <div className="relative rounded-full overflow-hidden border-4  border-2 border-gray-300 border-pink-500">
          <div className="md:w-[50%] xs:w-[90%]   xs:mx-auto sm:mx-auto  sm:m-auto justify-center px-4 block rounded-[50px] md:hidden flex w-[30%] border-r-2 border-gray-200 fixed top-0 right-0 absolute inset-0 flex items-center justify-center">
            <Image
