    ...
    <div className="grid grid-cols-12">
      ...
      <div className="flex mt-2 justify-center">
        <div className="relative rounded-full overflow-hidden border-4  border-2 border-gray-300 ">
          <div className="rounded-[80px] rounded-[50px] rounded-[300px] border-2 border-pink-500 md:hidden xs:block md:text-[16px] md:w-[50%] xs:w-[90%]   xs:mx-auto sm:mx-auto  sm:m-auto justify-center px-4 block rounded-[50px] md:hidden flex w-[30%] block md:hidden border-r-2 border-gray-200 fixed top-0 right-0 absolute inset-0 flex items-center justify-center">
